...
#stl_file_path = r"/mnt/c/Users/cjgn44/Google Drive/ULB/SCOTS4/2804/AMATS139C_adjustedimagemmperpx/postprocessing/w0.stl"
...
sampler = RGBAdaptiveSampler2D(rgb_pipeline, min_samples=50, fraction=0.2)
#def dir: pos z
...
camera.observe()
rgb_pipeline.save(output_file_path)

#debug
intensity_values = rgb_pipeline.frame[..., 0]  # Assuming the R, G, and B channels have the same values
