...
testNames{1} = 'data/23_05_2023_debugging3/cam50mmX';
zerophase = 0;
acquire = 0;
integrate = 1;
aqPar.isPetal = 0;
%% Compute global variables
aqPar.phases = 0:2*pi/8:2*pi; %0:2*pi/16:2*pi*2
...
aqPar.imageMirrorCenterX_px = 158;%358; %px, Location of the mirror in CAM image
aqPar.imageMirrorCenterY_px = 96; %top left, down right positive.
